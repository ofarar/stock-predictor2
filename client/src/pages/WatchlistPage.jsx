...
const WatchlistPage = ({ settings }) => {
    ...
    const fetchAllData = useCallback(() => {
        ...
        Promise.all([
            ...
            axios.get(`${import.meta.env.VITE_API_URL}/api/watchlist`, { withCredentials: true })
    ...
    const handleLoadMorePredictions = (ticker) => {
        ...
        axios.get(`${import.meta.env.VITE_API_URL}/api/watchlist/${ticker}/predictions?page=${nextPage}`, { withCredentials: true })
            .then(res => {
    ...
    const handleDragEnd = (event) => {
        ...
        if (active.id !== over.id) {
            ...
            axios.put(`${import.meta.env.VITE_API_URL}/api/watchlist/order`, { tickers: newTickerOrder }, { withCredentials: true })
                .catch(() => {
    ...
    const handleFollow = (userIdToFollow) => {
        const promise = axios.post(`${import.meta.env.VITE_API_URL}/api/users/${userIdToFollow}/follow`, {}, { withCredentials: true })
            .then(() => {
        ...
        <>
            ...
            <div className="animate-fade-in space-y-8">
                <div className="flex items-center gap-4">
                    ...
                    <button onClick={() => setIsAddModalOpen(true)} aria-label="Add Stock" className="bg-gray-700 text-gray-400 rounded-full w-8 h-8 flex items-center justify-center hover:bg-gray-600">
