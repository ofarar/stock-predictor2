...
const AIWizardPage = ({ user }) => {
    ...
    useEffect(() => {
        if (user) {
            axios.get(`${import.meta.env.VITE_API_URL}/api/ai-wizard/waitlist-status`, { withCredentials: true })
    ...
    const handleJoinWaitlist = () => {
        const promise = axios.post(`${import.meta.env.VITE_API_URL}/api/ai-wizard/join-waitlist`, {}, { withCredentials: true })
    ...
    return (
        <div className="max-w-4xl mx-auto text-center animate-fade-in pt-4">
            ...
            {/* This section now mirrors the structure and styling of AboutPage.js */}
            <div className="mt-10">
                <h2 className="text-2xl font-semibold text-green-400 mb-4">{t('aiwizard_how_it_works')}</h2>
                <div className="horizontal-fade">
                    <div className="flex gap-6 overflow-x-auto pb-4 scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-gray-800 px-8">
