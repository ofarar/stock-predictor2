...
const FollowersPage = ({ settings }) => {
    ...
    const handleUnfollow = (userIdToUnfollow) => {
        ...
        // API Call
        const promise = axios.post(`${import.meta.env.VITE_API_URL}/api/users/${userIdToUnfollow}/unfollow`, {}, { withCredentials: true });
    ...
    const fetchFollowData = useCallback(async () => {
        try {
            setLoading(true);
            const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/users/${userId}/follow-data-extended`, { withCredentials: true });
    ...
    const handleConfirmCancel = () => {
        ...
        const promise = axios.post(
            `${import.meta.env.VITE_API_URL}/api/users/${userToUnsubscribe._id}/cancel-golden`,
            {},
