...
const CompleteProfilePage = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`${import.meta.env.VITE_API_URL}/api/pending-profile`, { withCredentials: true })
            .then(res => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`${import.meta.env.VITE_API_URL}/api/complete-registration`, { username }, { withCredentials: true });
