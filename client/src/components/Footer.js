        ...
        <footer className="bg-gray-900 border-t border-gray-800 mt-20">
            <div className="container mx-auto py-8 px-6">
                <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    {/* --- START: NEW CUSTOM LANGUAGE SELECTOR --- */}
                    ...
                    {/* --- END: NEW CUSTOM LANGUAGE SELECTOR --- */}
                </div>
                <div className="text-center text-gray-500 mt-8">&copy; {currentYear} StockPredictor. {t('footer.copyright')}</div>
            </div>
        </footer>
    );
};
