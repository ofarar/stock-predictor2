        ...
        <div className="relative" ref={userDropdownRef}>
            ...
            {isUserMenuOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-gray-800 rounded-lg shadow-xl py-2 z-20">
                    ...
                    {/* Corrected "My Profile" Icon */}
                    <Link to={`/profile/${user._id}`} className="flex items-center px-4 py-2 text-sm text-gray-300 hover:bg-gray-700">
                    ...
                    {/* Corrected "Edit Profile" Icon */}
                    <Link to="/profile/edit" className="flex items-center px-4 py-2 text-sm text-gray-300 hover:bg-gray-700">
