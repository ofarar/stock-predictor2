...
### 📈 Active Predictions
Transparency is key. Your **Active Predictions** tab shows all your open positions, allowing followers to track your live performance and strategy.

![Active Predictions](./images/06_profile_active_predictions.png)

### 📜 Track Record: Prediction History
Build trust with a solid history. The **Prediction History** tab archives all your past calls, serving as a verifiable ledger of your success rate over time.

![Prediction History](./images/07_profile_history.png)

### 🤝 Community: Followers
Grow your influence. The **Followers** tab lets you manage your community and see who's tracking your insights.

![Followers](./images/08_profile_followers.png)

---

## 6. 💰 Monetize Your Skill: Creator Pool
Join the elite. The **Creator Pool** is where top performers get rewarded. Share in the platform's success based on your contribution and ranking.

![Creator Pool Modal](./images/09_creator_pool_modal.png)

### 📊 Deep Dive: Creator Stats
Analyze your impact. The **Creator Detail View** breaks down your performance metrics, showing exactly how you're contributing to the pool and earning your share.

![Creator Pool Detail](./images/10_creator_pool_detail.png)
...
## 9. 📉 Market Focus: Stock Page (AAPL)
Dive deep into individual assets. The **Stock Page** provides detailed information, real-time charts, and community sentiment for specific stocks like Apple (AAPL).

![Stock Page](./images/13_stock_page_aapl.png)

### 🌟 Top Predictors for AAPL
Who knows AAPL best? See the **Top Predictors** for each specific stock to find experts who specialize in the assets you care about.
